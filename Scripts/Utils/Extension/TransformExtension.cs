...
public static class TransformExtension
{
    ...
    {
        transfrom.GetComponent<Image>()?.DOFade(endvalue, duration).OnComplete(() => { callback?.Invoke(); });
    }

    public static void DoFadeCanvas(this Transform transfrom, float endvalue, float duration, System.Action callback = null)
    {
        transfrom.GetComponent<CanvasGroup>()?.DOFade(endvalue, duration).OnComplete(() => { callback?.Invoke(); });
    }
    ...
    public static void DoFadeOnce(this Transform transfrom, float duration, System.Action callback = null)
    {
        ...
        transfrom.GetComponent<Image>()?.DOFade(0, duration).OnComplete(() => { callback?.Invoke(); });
    }
    ...
    public static void DoRotation(this Transform transfrom, Vector3 origin, Vector3 rotation, float duration, Ease ease = Ease.InOutQuad, System.Action callback = null)
    {
        ...
        transfrom?.DORotate(rotation, duration).SetEase(ease)
                .OnComplete(() =>
                {
    ...
    {
        transfrom?.DORotate(rotation, duration)
                .OnComplete(() =>
                {
                    transfrom.ResetRotation();
                    callback?.Invoke();
    ...
    public static void PlayShakeRotation(this Transform transfrom, float duration, float strength, System.Action callback = null)
    {
        transfrom.DOShakeRotation(duration, new Vector3(0, 90, 0) * strength).OnComplete(() => { callback?.Invoke(); });
    }


    public static void PlayShakeScale(this Transform transfrom, float duration, float strength = 1, System.Action callback = null)
    {
        transfrom?.DOShakeScale(duration, strength, 50)
    ...
    public static void DoKill(this Transform transfrom)
    {
        transfrom.DOKill();
    }
