...
public class ActorMeleeAttack : MonoBehaviour
{
    ...
    [Header("[Setting]")]
    [SerializeField] private MeleeAttackNormal normal;
    [SerializeField] private MeleeAttackSkill_1 skill_1;
    [SerializeField] private MeleeAttackSkill_2 skill_2;
    [SerializeField] private MeleeAttackSkill_3 skill_3;
    ...
    // [properties]
    public MeleeAttackNormal AttackNormal { get => normal; }
    public MeleeAttackSkill_1 AttackSkill_1 { get => skill_1; }
    public MeleeAttackSkill_2 AttackSkill_2 { get => skill_2; }
    public MeleeAttackSkill_3 AttackSkill_3 { get => skill_3; }
    ...
    public void Init(SOActorMelee SO, ActorMelee actor)
    {
        _owner = actor;
