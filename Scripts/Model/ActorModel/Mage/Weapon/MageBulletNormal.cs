...
public class MageBulletNormal : MonoBehaviour
{
    ...
    [SerializeField] private ActorMage owner;
    ...
    {
        attack = data;
        owner = actor.GetComponent<ActorMage>();
    ...
    {
        transform.LookAt(owner.CurrentEnemy.transform);
    }
